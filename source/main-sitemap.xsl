      ...
      <body>
        <div id="content">
          ...
          <xsl:if test="count(sitemap:sitemapindex/sitemap:sitemap) &lt; 1">
            ...
            <p class="expl"><a href="http://matthewlehner.net/sitemap_index.xml">&#8593; Sitemap Index</a></p>
            <table id="sitemap" cellpadding="3">
              <thead>
                <tr>
                  <th width="75%">URL</th>
        ...
        <!-- <script type="text/javascript" src="http://matthewlehner.net/wp&#45;content/plugins/wordpress&#45;seo/js/jquery.tablesorter.min.js"></script> -->
